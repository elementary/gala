/* mutter-cogl.vapi generated by vapigen, do not modify. */
...
namespace Cogl {
	...
	public class Material {
		[CCode (has_construct_function = false)]
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline")]
		public Material ();
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_alpha_test_function", since = "1.0")]
		public void set_alpha_test_function (Cogl.MaterialAlphaFunc alpha_func, float alpha_reference);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_blend", since = "1.0")]
		public bool set_blend (string blend_string) throws GLib.Error;
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_blend_constant", since = "1.0")]
		public void set_blend_constant (Cogl.Color constant_color);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_color", since = "1.0")]
		public void set_color (Cogl.Color color);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_color4ub", since = "1.0")]
		public void set_color4ub (uint8 red, uint8 green, uint8 blue, uint8 alpha);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_layer", since = "1.0")]
		public void set_layer (int layer_index, [CCode (type = "CoglHandle")] Cogl.Texture texture);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_layer_combine", since = "1.0")]
		public bool set_layer_combine (int layer_index, string blend_string) throws GLib.Error;
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_layer_combine_constant", since = "1.0")]
		public void set_layer_combine_constant (int layer_index, Cogl.Color constant);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_layer_filters")]
		public void set_layer_filters (int layer_index, Cogl.MaterialFilter min_filter, Cogl.MaterialFilter mag_filter);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_layer_matrix")]
		public void set_layer_matrix (int layer_index, Cogl.Matrix matrix);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_layer_point_sprite_coords_enabled", since = "1.4")]
		public bool set_layer_point_sprite_coords_enabled (int layer_index, bool enable) throws GLib.Error;
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_point_size", since = "1.4")]
		public void set_point_size (float point_size);
		[Version (deprecated = true, deprecated_since = "1.16", replacement = "Cogl.Pipeline.set_user_program", since = "1.4")]
		public void set_user_program ([CCode (type = "CoglHandle")] Cogl.Program program);
	}
	...
	public class Matrix {
		...
		[Version (since = "1.2")]
		public bool get_inverse (out unowned Cogl.Matrix inverse);
	...
	public class Onscreen : Cogl.Object, Cogl.Framebuffer {
		...
		[CCode (cheader_filename = "cogl/cogl.h", cname = "cogl_x11_onscreen_get_window_xid")]
		[Version (since = "1.10")]
		public uint32 get_window_xid ();
		[Version (since = "2.0")]
		public void hide ();
		[Version (since = "1.16")]
	...
	public class Pipeline : Cogl.Object {
		...
		[Version (since = "2.0")]
		public Cogl.Program get_user_program ();
		[Version (since = "1.10")]
	...
	[CCode (cheader_filename = "cogl/cogl.h", cname = "CoglHandle", lower_case_csuffix = "program", type_id = "cogl_handle_get_type ()")]
	public class Program : Cogl.Object {
		[CCode (cheader_filename = "cogl/cogl.h", cname = "cogl_create_program", has_construct_function = false, type = "CoglHandle")]
		[Version (deprecated = true, deprecated_since = "1.16")]
		public Program ();
		[CCode (cheader_filename = "cogl/cogl.h")]
		[Version (deprecated = true, deprecated_since = "1.16")]
		public void attach_shader ([CCode (type = "CoglHandle")] Cogl.Shader shader_handle);
		[CCode (cheader_filename = "cogl/cogl.h")]
		[Version (deprecated = true, deprecated_since = "1.16")]
		public int get_uniform_location (string uniform_name);
		[CCode (cheader_filename = "cogl/cogl.h")]
	...
	[CCode (cheader_filename = "cogl/cogl.h", cname = "CoglHandle", lower_case_csuffix = "shader", type_id = "cogl_handle_get_type ()")]
	public class Shader : Cogl.Object {
		[CCode (cheader_filename = "cogl/cogl.h", cname = "cogl_create_shader", has_construct_function = false, type = "CoglHandle")]
		[Version (deprecated = true, deprecated_since = "1.16")]
	...
	public interface Texture : Cogl.Object {
		...
		public static Cogl.Texture new_from_data (int width, int height, Cogl.TextureFlags flags, Cogl.PixelFormat format, Cogl.PixelFormat internal_format, int rowstride, [CCode (array_length = false, type = "const uint8_t*")] uint8[] data);
		[Version (deprecated = true, deprecated_since = "1.18", since = "0.8")]
		...
		public bool set_data (Cogl.PixelFormat format, int rowstride, [CCode (array_length = false, type = "const uint8_t*")] uint8[] data, int level) throws GLib.Error;
		[Version (since = "1.18")]
		public void set_premultiplied (bool premultiplied);
		public bool set_region (int src_x, int src_y, int dst_x, int dst_y, uint dst_width, uint dst_height, int width, int height, Cogl.PixelFormat format, uint rowstride, [CCode (array_length = false, type = "const uint8_t*")] uint8[] data);
		[Version (since = "1.8")]
