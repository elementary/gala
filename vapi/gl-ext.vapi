...
namespace GL_EXT {
	...
	public static void glMemoryObjectParameterivEXT (GL.GLuint memoryObject, GL.GLenum pname, [CCode (array_length = false)] GL.GLint[] @params);
	[CCode (cheader_filename = "GL/glew.h", cname = "glGetMemoryObjectParameterivEXT")]
	public static void glGetMemoryObjectParameterivEXT (GL.GLuint memoryObject, GL.GLenum pname, [CCode (array_length = false)] GL.GLint[] @params);
