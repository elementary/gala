...
namespace Vk {
    ...
    [CCode (cheader_filename = "vulkan/vulkan_core.h", cprefix = "VK_IMAGE_LAYOUT_", has_type_id = false)]
    ...
    [CCode (cheader_filename = "vulkan/vulkan_core.h", cprefix = "VK_FORMAT_", has_type_id = false)]
    public enum Format {
        UNDEFINED = 0,
        R4G4_UNORM_PACK8 = 1,
