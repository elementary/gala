...
namespace Gala {
    ...
    public class WindowManagerGala : Meta.Plugin, WindowManager {
        ...
        private void on_menu_get (GLib.Object? o, GLib.AsyncResult? res) {
            try {
        ...
        private void configure_hotcorners () {
#if HAS_MUTTER330
            unowned Meta.Display display = get_display ();
        ...
        private void move_window_to_next_ws (Window window) {
        ...
        private void move_window_to_old_ws (Window window) {
            unowned Workspace win_ws = window.get_workspace ();
        ...
        private bool end_animation (ref Gee.HashSet<Meta.WindowActor> list, WindowActor actor) {
